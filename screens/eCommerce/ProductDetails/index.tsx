      ...
      >
        ...
        >{data ? (
          ...
          <Layout style={styles.layout} level={"2"}>
            <Text children={dataNFT ? `Discount:${dataNFT.discount}` : ""} status="primary" category="title4" />
            <Text children={dataNFT ? `Expired Date:${dataNFT.expired_date}` : ""} status="primary" category="title4" />
          </Layout>
        </View>
      </KeyboardAwareScrollView>
      <View style={[styles.bottom, { paddingBottom: bottom + 8 }]}>
 
        <Button children="Close" onPress={() => goBack()} style={styles.buyNow} />
      </View>
    </Container>
  );
});
