...
const AssetIconsPack: IconPack<ImageProps | SvgProps> = {
  ...
  icons: {
    ...
    facebook_circle: createIcon(Icons.facebook_circle),
    instagram: createIcon(Icons.instagram),
    instagram_large: createIcon(Icons.instagram_large),
    behance: createIcon(Icons.behance),
    pinterest: createIcon(Icons.pinterest),
    twitter: createIcon(Icons.twitter),
    twitter_large: createIcon(Icons.twitter_large),
    ...
    navigate: createIcon(Icons.navigate),
  },
};
